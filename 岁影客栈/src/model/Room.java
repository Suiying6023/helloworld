 ...
 *   <li>{@link #getRooms() }：获取房间列表的方法，返回一个 {@code LinkedHashMap} 对象，并初始化一些房间对象作为示例数据。</li>
 ...
 *   <li>{@link #equals(Object) }：判断两个房间对象是否相等的方法，根据 id，type 和 info 属性进行比较，并返回一个 {@code boolean} 值。</li>
...
public class Room {
    ...
    private static LinkedHashMap<String, Room> rooms =
            new LinkedHashMap<String, Room>();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Room) {
            Room r = (Room) obj;
            return id.equals(r.id) && type.equals(r.type)
                    && info.equals(r.info);
        }
        return false;
    }
    ...
    public static void updateBookedDates(
            String id, LocalDate checkInDate, LocalDate checkOutDate, int num) {
        // 获取当前日期
